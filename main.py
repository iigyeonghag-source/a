...
ROLE_MESSAGES = {
    ...
    "개씹덕": "🎉 축하해! 이제 {user}은/는 되돌릴 수 없는 @개씹덕 단계에 도달했어!",
    "디창": "🎉 축하해! 우리 {user}이는 이제는 아예 디스코드에 영혼을 바친 @디창이 됐구나!",
    "초보": "🎉 축하해! {user}가 @초보 역할을 달성했어! 드디어 첫걸음이구나?",
    "중수": "🎉 축하해! {user}가 @중수 역할을 얻었구나? 음성 채팅을 많이 하네!",
    "고수": "🎉 축하해! {user}가 @고수 역할을 얻어냈어! 너 음성 채팅을 정말 많이하는 구나!",
    "고인물": "🎉 축하해! {user}가 @고인물 역할을 얻어냈네? 어떻게 했어! 아무튼 대단해!",
    "썩은물": "🎉 축하해! {user}가 @썩은물 역할을 얻어냈어!! 너 혹시 음성 채팅의 화신이니?"
}
